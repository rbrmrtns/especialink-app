...
export const AreaDeAtuacaoCard = ({ areaDeAtuacao }) => {
  ...
  const texto = {
    ...
    terapia_ocupacional: "O(a) terapeuta ocupacional responsável por reabilitar indivíduos afetados por limitações físicas, cognitivas ou emocionais para as atividades do dia a dia."
  }
  ...
  const urlImg = {
    ...
    terapia_ocupacional: require('../assets/images/area_de_atuacao/terapia-ocupacional.png')
  }  
